...
if(isset($_POST))
{
	...
	$BigImageMaxSize 		= 1300; //Image Maximum height or width
	$ThumbPrefix			= "thumb_"; //Normal thumb Prefix
	$DestinationDirectory	= '../../../images/article/'; //specify upload directory ends with / (slash)
	...
	if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
	{
		...
		*/
		...
		echo '<tr>';
		echo '<td align="center">Miniature</td>';
		echo '<td width="200px" align="center"><img width="200px" id="ph1" src="../images/article/'.$ThumbPrefix.$NewImageName.'" alt="Thumbnail"></td>';
		echo '</tr><tr>';
